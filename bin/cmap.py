...
CMAP = '/media/data/work/tmp/tigris-0922/flow011-rdp/umc110-m3-15ns-1.2area-ctoolfp/gp-debug/banyan_1696751021219.cmap'
...
if __name__ == '__main__':
    ...
    profiles = [
        ('banyan_1696751021219.vertical.svg', maoshan.cmap.Axis.VERTICAL),
        ('banyan_1696751021219.horizontal.svg', maoshan.cmap.Axis.HORIZONTAL),
    ]
